$(document).ready ->
 ...
 App.answers = App.cable.subscriptions.create { channel: "AnswersChannel", question: question_id },
   ...
   received: (data) ->
    ...
    #answer = simple_answer + "#{ j render partial: 'answers/best_voting', locals: { answer: data }}" "#{ j render partial: 'layouts/rating', locals: { parent_object: data }}" "#{ j render partial: 'layouts/attached_files', locals: { parent_object: data }}""
